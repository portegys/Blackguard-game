...
#define FMOD_VERSION    0x00040309
...
#define FMOD_CAPS_HARDWARE               0x00000001
                                                  /* Device supports FMOD_HARDWARE but it will be mixed on the CPU by the kernel (not FMOD's software mixer). */
...
typedef enum
{
    ...
    FMOD_SPEAKER_MONO        = FMOD_SPEAKER_FRONT_LEFT,
                                                  /* For use with FMOD_SPEAKERMODE_SURROUND and Channel::SetSpeakerLevels only.  Mapped to same value as FMOD_SPEAKER_LOW_FREQUENCY. */
...
#define FMOD_INIT_DISABLESOFTWARE         0x00000004
...
#define FMOD_REVERB_FLAGS_CORE1                 0x00000200
                                                  /* GameCube only. Use high quality reverb */
