...
struct h_list helpstr[] = {
	...
	'.',	"	rest for a while",
	'i',	"/I	inventory pack/single item",
	'q',	"	quaff potion",
	'r',	"	read a scroll",
	'e',	"	eat food",
	'w',	"	wield a weapon",
...
#endif
#if ANDROID || METRO
	'B',	"ack	cancel command",
#else
	ESCAPE,	"	cancel command",
#endif
#if ANDROID || METRO
	'S',	"	show scores",
	'Q',	"	quit and start new game",
#else
	'S',	"	save game",
	'Q',	"	quit",
#endif
#ifdef BLACKGUARD
	'M',	"	toggle mute",
	'A',	"rrows	move and turn",
#if ANDROID || METRO
	'S',	"wipe	move and turn",
#ifdef ANDROID
...
struct magic_item a_magic[MAXARMORS + 1] = {
	{ "leather armor",			170,  170, 5 },
	{ "ring mail",				130,  130, 30 },
	{ "studded leather armor",	130,  130, 20 },
	{ "scale mail",				120,  120, 3 },
	{ "padded armor",			100,  100, 250 },
	{ "chain mail",				 90,  90,  75 },
	{ "splint mail",			 90,  90,  80 },
	{ "banded mail",			 90,  90,  90 },
	{ "plate mail",		 		 50,  50,  400 },
	{ "plate armor",			 30,  30,  650 },
	{ NULL,						 0,   0,   0 },
};
...
struct magic_item w_magic[MAXWEAPONS + 1] = {
	...
	{ "dagger",				 20,  20, 5 },
	{ "rock",				 20,  20, 1 },
	{ "two-handed sword",	 50,  50, 120 },
	{ "sling",				 20,  20, 5 },
	{ "dart",				 30,  30, 3 },
	{ "crossbow",			 60,  60, 70 },
	{ "crossbow bolt",		 60,  60, 3 },
	{ "spear",				 70,  70, 8 },
	{ "trident",			 70,  70, 90 },
	{ "spetum",				 70,  70, 50 },
	{ "bardiche",			 70,  70, 30 },
	{ "pike",				 70,  70, 75 },
	{ "bastard sword",		 60,  60, 100 },
	{ "halberd",			 70,  70, 40 },
	{ NULL,					  0,  0,  0 },
};
...
struct magic_item s_magic[MAXSCROLLS + 1] = {
	{ "monster confusion",	 50, 50, 200 },
	{ "magic mapping",		 52, 52, 200 },
	{ "light",				 80, 80, 100 },
	{ "hold monster",		 25, 25, 200 },
	{ "sleep",				 41, 41, 50 },
	{ "enchant armor",		 75, 75, 175 },
	{ "identify",			211, 211, 150 },
	{ "scare monster",		 42, 42, 300 },
	{ "gold detection",		 32, 32, 100 },
	{ "teleportation",		 73, 73, 200 },
	{ "enchant weapon",		 91, 91, 175 },
	{ "create monster",		 34, 34, 75 },
	{ "remove curse",		 82, 82, 100 },
	{ "aggravate monsters",	 10, 10, 50 },
	{ "blank paper",		 11, 11, 50 },
	{ "genocide",			  5, 5,  350 },
	{ "item knowledge",		 14, 14, 250 },
	{ "item protection",	  9, 9,  250 },
	{ "demons curse",		  5, 5,  25 },
	{ "transport",			 11, 11, 100 },
	{ "enchantment",		  3, 3,  300 },
	{ "gods blessing",		  4, 4,  450 },
	{ "aquirement",			  3, 3,  450 },
	{ "banishment",			  5, 5,  25 },
	{ "recharge wand",		 14, 14, 250 },
	{ "locate traps",		 18, 18, 185 },
	{ NULL,					  0, 0,  0 },
};
...
struct magic_item p_magic[MAXPOTIONS + 1] = {
	...
	{ "paralysis",			 69,  69,  50 },
	{ "poison",				 55,  55,  50 },
	{ "gain strength",		130,  130, 150 },
	{ "see invisible",		 25,  25,  175 },
	{ "healing",			120,  120, 130 },
	{ "monster detection",	 59,  59,  120 },
	{ "magic detection",	 54,  54,  105 },
	{ "raise level",		 25,  25,  300 },
	{ "extra healing",		 52,  52,  175 },
	{ "haste self",			 41,  41,  200 },
	{ "restore strength",	140,  140, 200 },
	{ "blindness",			 25,  25,  50 },
	{ "thirst quenching",	 10,  10,  50 },
	{ "increase dexterity",	 50,  50,  175 },
	{ "etherealness",		 20,  20,  150 },
	{ "increase wisdom",	 35,  35,  175 },
	{ "regeneration",		 10,  10,  175 },
	{ "super ability",		  3,  3,   500 },
	{ "decrepedness",		  4,  4,   25 },
	{ "invincibility",		  4,  4,   500 },
	{ NULL,					  0,  0,   0 },
};

struct magic_item r_magic[MAXRINGS + 1] = {
	{ "protection",			 71, 71, 200 },
	{ "strength",			 70, 70, 200 },
	{ "sustain strength",	 45, 45, 250 },
	{ "searching",			 70, 70, 150 },
	{ "see invisible",		 77, 77, 175 },
	{ "constitution",		 13, 13, 350 },
	{ "aggravate monster",	 60, 60, 100 },
	{ "agility",			 75, 75, 250 },
	{ "increase damage",	 61, 61, 250 },
	{ "regeneration",		 41, 41, 250 },
	{ "digestion",			 60, 60, 225 },
	{ "teleportation",		 60, 60, 100 },
	{ "stealth",			 75, 75, 200 },
	{ "speed",				 40, 40, 225 },
	{ "find traps",			 27, 27, 200 },
	{ "delusion",			 18, 18, 100 },
	{ "sustain ability",	  9, 9,  450 },
	{ "blindness",			 10, 10, 50 },
	{ "lethargy",			 14, 14, 75 },
	{ "ogre strength",		  8, 8,  350 },
	{ "enfeeblement",		  5, 5,  25 },
	{ "burden",				 10, 10, 50 },
	{ "illumination",		 16, 16, 100 },
	{ "fire protection",	  5, 5,  225 },
	{ "wisdom",				 25, 25, 200 },
	{ "dexterity",			 35, 35, 200 },
	{ NULL,					  0, 0,  0 },
};
...
struct magic_item ws_magic[MAXSTICKS + 1] = {
	...
	{ "cold",				 30, 30, 200 },
	{ "polymorph",			 95, 95, 210 },
	{ "magic missile",		 70, 70, 170 },
	{ "haste monster",		 80, 80, 50 },
	{ "slow monster",		 90, 90, 220 },
	{ "drain life",			 80, 80, 210 },
	{ "nothing",			 10, 10, 70 },
	{ "teleport away",		 55, 55, 140 },
	{ "teleport to",		 50, 50, 60 },
	{ "cancellation",		 55, 55, 130 },
	{ "sap life",			 20, 20, 50 },
	{ "curing",				 25, 25, 250 },
	{ "pyromania",			 15, 15, 25 },
	{ "annihilate monster",	  5, 5,  750 },
	{ "paralyze monster",	 10, 10, 650 },
	{ "food absorption",	 10, 10, 75 },
	{ "regenerate monster",	 15, 15, 25 },
	{ "hide monster",		 10, 10, 50 },
	{ "anti-matter",		  5, 5,  25 },
	{ "clone monster",		 10, 10, 10 },
	{ "confuse monster",	 15, 15, 150 },
	{ "degenerate monster",	 15, 15, 150 },
	{ NULL,					  0, 0,  0 },
};
