...
MKDIRS="sh /cygdrive/c/Users/Tom/Downloads/ncurses-5.7/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /cygdrive/c/Users/Tom/Downloads/ncurses-5.7/man_alias.sed ; then
cat >>/cygdrive/c/Users/Tom/Downloads/ncurses-5.7/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /cygdrive/c/Users/Tom/Downloads/ncurses-5.7/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /cygdrive/c/Users/Tom/Downloads/ncurses-5.7/man_alias.sed | sort -u`
	...
	sed	-f /cygdrive/c/Users/Tom/Downloads/ncurses-5.7/man_alias.sed \
		< $i >$TMP
